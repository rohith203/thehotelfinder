...
public class MyProfileFrame extends javax.swing.JFrame {
    ...
    public MyProfileFrame() {
        ...
        addressLabel.setText(TheHotelFinder.curUser.getAddress()[0] +  ", " + 
                             TheHotelFinder.curUser.getAddress()[1] + ", " +
                             TheHotelFinder.curUser.getAddress()[2]
                             );
        usernameLabel.setText(TheHotelFinder.curUser.getUsername());
        emailLabel.setText(TheHotelFinder.curUser.getEmail());
        String asters = "";
        for(int i=0; i<TheHotelFinder.curUser.getPassword().length(); i++){
            asters+="*";
        }
    ...
    private void passwordToggleBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_passwordToggleBtnActionPerformed
        ...
        if(passwordToggleBtn.isSelected()){
            ...
            passwordLabel.setText(TheHotelFinder.curUser.getPassword());
        }else{
            passwordToggleBtn.setText("show");
            String asters = "";
            for(int i=0; i<TheHotelFinder.curUser.getPassword().length(); i++){
